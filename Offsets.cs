...
namespace RogueCompany
{
    ...
    {
        public static Int64 UWorld = 0x6A0AE18;
        public static Int64 GNames = 0x689C100;
        ...
        public class UE
        {
            ...
            public class AActor
            {
                ...
                public static Int64 Health = 0x528;
                public static Int64 CurrentActorHPMax = 0x2894;
                public static Int64 actor_pawn = 0x118;
                public static Int64 bKickbackEnableds = 0xAF8;
                public static Int64 LAKSTeamState = 0x398;
                public static Int64 LTeamNum = 0x220;
                public static Int64 AKSTeamState = 0x398;
